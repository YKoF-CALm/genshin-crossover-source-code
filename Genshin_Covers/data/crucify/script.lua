function onStepHit()
    if curStep >= 0 and curStep < 12 then
        local curBeat
            for i=0,7 do
                setActorX(_G['defaultStrum'..i..'X'] + 25 * math.sin((curBeat + i*50) * math.pi), i)
                setActorY(_G['defaultStrum'..i..'Y'] + 5 * math.cos((curBeat + i*0.25) * math.pi), i)
        end
    end
    ...
    if curStep >= 1024 and curStep < 1154 then
        local curBeat
            for i=0,7 do
                setActorY(_G['defaultStrum'..i..'Y'] + 25 * math.cos((curBeat + i*5) * math.pi), i)
        end
    end
    ...
    if curStep >= 12 and curStep < 16 then
        local curBeat
            for i=0,7 do
            setActorY(_G['defaultStrum'..i..'Y'] + -120 * math.cos((curBeat + i*10) * math.pi), i)
        end	
    end
    ...
    if curStep >= 124 and curStep < 126 then
        local curBeat
            for i=0,7 do
            setActorY(_G['defaultStrum'..i..'Y'] + 118 * math.cos((curBeat + i*10) * math.pi), i)
        end	
    end
