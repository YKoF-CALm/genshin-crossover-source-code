function onUpdate(elapsed)
	...
	if curStep >= 0 and curStep < 12 then
		local currentBeat = (songPos/1000)*(curBpm/60)
			for i=0,3 do
				noteTweenX(defaultOpponentStrumX..i, i, (defaultOpponentStrumX + i) + 25 * math.sin((currentBeat + i * 50) * math.pi), 0.1)
				noteTweenY(defaultOpponentStrumY..i, i, (defaultOpponentStrumY + i) + 5 * math.cos((currentBeat + i * 0.25) * math.pi), 0.1)
				noteTweenX(defaultPlayerStrumX..i, i + 4, (defaultPlayerStrumX + i) + 25 * math.sin((currentBeat + i * 50) * math.pi), 0.1)
				noteTweenY(defaultPlayerStrumY..i, i + 4, (defaultPlayerStrumY + i) + 5 * math.cos((currentBeat + i * 0.25) * math.pi), 0.1)
			end
	end
