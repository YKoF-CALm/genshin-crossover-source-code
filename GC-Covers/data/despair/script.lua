...
function onCreate()
    ...
    makeAnimatedLuaSprite('Piper','indie/bendy/third/PiperDespair',2500,getProperty('boyfriend.y') - 200)
    ...
    makeAnimatedLuaSprite('Striker','indie/bendy/third/StrikerDespair',-200,getProperty('boyfriend.y') - 160)
    ...
    makeAnimatedLuaSprite('AttackButton','indie/IC_Buttons',50,300)
    ...
    makeAnimatedLuaSprite('BF_Bendy','characters/BoyFriend_NM_Bendy',getProperty('boyfriend.x'),getProperty('boyfriend.y') - 270)
    ...
    scaleObject('BF_Bendy',1.6,1.6)
    
    makeLuaSprite('SplashScreen1','indie/bendy/Damage01',0,0)
    scaleObject('SplashScreen1',0.7,0.7)

    makeLuaSprite('SplashScreen2','indie/bendy/Damage02',0,0)
    scaleObject('SplashScreen2',0.7,0.7)

    makeLuaSprite('SplashScreen3','indie/bendy/Damage03',0,0)
    scaleObject('SplashScreen3',0.7,0.7)

    makeLuaSprite('SplashScreen4','indie/bendy/Damage04',0,0)
    scaleObject('SplashScreen4',0.7,0.7)
        ...
        if not lowQuality then
            makeLuaSprite('InkedShit','indie/bendy/third/Ink_Shit',520,0)
            makeLuaSprite('InkedShit2','indie/bendy/third/Ink_Shit',-240,0)
            makeLuaSprite('InkedShit3','indie/bendy/third/Ink_Shit',-1000,0)
            makeAnimatedLuaSprite('Inked_Rain','indie/bendy/third/InkRain',0,0)
...
--[[
    ...
    if AttackEnable == true then
        ...
        if PiperSpawn == 0 then
            setProperty('Piper.x',3000)
            PiperHP = 3
            addLuaSprite('Piper',false)
            setObjectOrder('Piper',14)
            PiperX = false
            PiperSpawn = -1
            setProperty('Piper.y',getProperty('boyfriend.y') - 220)
            PiperAttacking = false
        end

        if StrikerSpawn == 0 then
            addLuaSprite('Striker',false)
            setProperty('Striker.x',-200)
            setProperty('Striker.y',getProperty('boyfriend.y') - 220)
        ...
        if getProperty('Piper.x') > getProperty('boyfriend.x') + 100 and PiperX == false and PiperHP > 0 and AttackEnable then
        ...
        if getProperty('Striker.x') < getProperty('boyfriend.x') - 600 and StrikerX == false and StrikerHP > 0 and AttackEnable then
        ...
        if getPropertyFromClass('flixel.FlxG', 'keys.pressed.SHIFT') and getProperty('AttackButton.animation.curAnim.name') == 'Static' and BFBendy_Attacking == false then
            ...
            if keyPressed('left') or not keyPressed('right') and not keyPressed('left') and PiperX == false and StrikerX == true  then
                ...
                setProperty('BF_Bendy.x',getProperty('boyfriend.x') - 580)
                setProperty('BF_Bendy.y',getProperty('boyfriend.y') - 270)
            ...
            if keyPressed('right') or not keyPressed('right') and not keyPressed('left') and StrikerX == false and PiperX == true then
                ...
                objectPlayAnimation('BF_Bendy','Attack',false)
                setProperty('BF_Bendy.x',getProperty('boyfriend.x')- 105)
                setProperty('BF_Bendy.y',getProperty('boyfriend.y') - 270)
        ...
        if getProperty('Piper.animation.curAnim.finished') == true then
            ...
            if getProperty('Piper.animation.curAnim.name') == 'Pre-Attack' then
                ...
                if Dodge1 == 1 then
                    Dodge1 = 0
                    setProperty('BF_Bendy.x',getProperty('boyfriend.x') - 150)
                    setProperty('BF_Bendy.y',getProperty('boyfriend.y') - 140)
                    setProperty('BF_Bendy.flipX',false)
                    addLuaSprite('BF_Bendy',false)
                    setProperty('boyfriend.visible',false)
        ...
        if getProperty('Piper.animation.curAnim.name') == 'Idle' then
            setProperty('Piper.x',getProperty('boyfriend.x') + PiperOffsetX + 400)
            setProperty('Piper.y',getProperty('boyfriend.y') + PiperOffsetY - 90)
        end

        if getProperty('Piper.animation.curAnim.name') == 'Attack' then
            setProperty('Piper.x',getProperty('boyfriend.x') + PiperOffsetX + 20)
            setProperty('Piper.y',getProperty('boyfriend.y') + PiperOffsetY - 310)
        end
        
        if getProperty('Piper.animation.curAnim.name') == 'Pre-Attack' then
            setProperty('Piper.x',getProperty('boyfriend.x') + PiperOffsetX + 325)
            setProperty('Piper.y',getProperty('boyfriend.y') + PiperOffsetY - 134)
        end

        if getProperty('Piper.animation.curAnim.name') == 'Hurt' then
            setProperty('Piper.x',getProperty('boyfriend.x') + PiperOffsetX + 280)
            setProperty('Piper.y',getProperty('boyfriend.y') + PiperOffsetY - 246)
        end


        
        if getProperty('Striker.animation.curAnim.name') == 'Idle' then
            setProperty('Striker.x',getProperty('boyfriend.x') + StrikerOffsetX - 450)
            setProperty('Striker.y',getProperty('boyfriend.y') + StrikerOffsetY - 40)
        end
        ...
        if getProperty('Striker.animation.curAnim.name') == 'Pre-Attack' then
            setProperty('Striker.x',getProperty('boyfriend.x') + StrikerOffsetX - 490)
            setProperty('Striker.y',getProperty('boyfriend.y')+ StrikerOffsetY -47)
        end

        if getProperty('Striker.animation.curAnim.name') == 'Hurt' then
            setProperty('Striker.x',getProperty('boyfriend.x') + StrikerOffsetX - 600)
            setProperty('Striker.y',getProperty('boyfriend.y')+ StrikerOffsetY - 120)
        end

        if getProperty('Striker.animation.curAnim.name') == 'Dead' then
            setProperty('Striker.x',getProperty('boyfriend.x') + StrikerOffsetX - 700)
            setProperty('Striker.y',getProperty('boyfriend.y') + StrikerOffsetY - 120)
        end
    end
