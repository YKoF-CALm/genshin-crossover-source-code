...
function onCreate()
    ...
    makeAnimatedLuaSprite('signDeath', 'tricky/signDeath');
    ...
    --cutscene sprites
        ...
        makeAnimatedLuaSprite('bf', 'characters/BOYFRIEND', 890, 450)
        luaSpriteAddAnimationByPrefix('bf', 'idle', 'BF idle dance', 24, true)
        addLuaSprite('bf', true)
        setObjectOrder('bf', 5)
        setPropertyLuaSprite('bf', 'alpha', 0)

        makeAnimatedLuaSprite('girlfriend', 'characters/GF_assets', 400, 130)
        ...
        makeAnimatedLuaSprite('trickman', 'tricky/trickman', 140, 280)
        ...
        makeAnimatedLuaSprite('trickbeam', 'tricky/trickman', -135, -290)
        ...
        makeAnimatedLuaSprite('youDontKillClown', 'tricky/youdontkillclown', 180, 530)
        ...
        makeAnimatedLuaSprite('clownKillsYou', 'tricky/clownkillsyou', 180, 530)
