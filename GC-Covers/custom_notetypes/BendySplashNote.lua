function onCreate()
	...
	SplashDamage = 0;
	SplashEffect = 1;
	RemoveSplahsEffect = true
		for i = 0, getProperty('unspawnNotes.length')-1 do
			--Check if the note is an Instakill Note
			if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'BendySplashNote' then
		
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'notes/BendySplashNoteAssets');--Change texture
		...
		makeLuaSprite('SplashScreen','indie/bendy/Damage01',0,0)
