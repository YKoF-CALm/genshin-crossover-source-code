function onCreate()
	...
	makeLuaSprite('background', 'holofunk/russia/motherBG', -750, -1000);
	addLuaSprite('background', false);
	scaleObject('background', 1.2, 1.2);
	setLuaSpriteScrollFactor('background', 0.5, 0.5);

	makeLuaSprite('stage', 'holofunk/russia/motherFG', -550, -720);
	scaleObject('stage', 1.1, 1.1);
	addLuaSprite('stage', false);

	makeLuaSprite('plants', 'holofunk/russia/plants', -770, -720);
