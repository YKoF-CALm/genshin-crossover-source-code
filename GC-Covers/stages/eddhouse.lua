function onCreate()
	precacheImage('challeng-edd/DoorOpen')
	precacheImage('challeng-edd/Matt')
	precacheImage('challeng-edd/Tom')
	precacheImage('challeng-edd/Eduardo')
	precacheImage('challeng-edd/EduardoCUTSCENE')
	precacheImage('challeng-edd/Mark')
	precacheImage('challeng-edd/John')
	...
	if not lowQuality then
		makeAnimatedLuaSprite('doorOpen', 'challeng-edd/DoorOpen', 600, 300); -- from that door on Hard comes up Matt with Tom
		...
		makeAnimatedLuaSprite('matt', 'challeng-edd/Matt', 560, 245); -- matt !!
		...
		makeAnimatedLuaSprite('tom', 'challeng-edd/Tom', 610, 245); -- tom !!
	...
	makeAnimatedLuaSprite('eduarC', 'challeng-edd/EduardoCUTSCENE', -1080, 125); -- eduardo punches john, cry about it =l
	addAnimationByPrefix('eduarC', 'punch', 'EduardoPunch', 24, false)
	setScrollFactor('eduarC', 1, 1);
	setProperty('eduarC.alpha', 0);
		
	makeAnimatedLuaSprite('eduar', 'challeng-edd/Eduardo', -1080, 125); -- eduardo
...
function onCreatePost()
		makeLuaSprite('eddI', 'challeng-edd/edd', getProperty('iconP1.x'), getProperty('iconP1.y'))
