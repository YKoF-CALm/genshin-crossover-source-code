function onCreate()
	...
	precacheImage('challeng-edd/Fallin')
	...
	if not lowQuality then
		...
		makeLuaSprite('city', 'challeng-edd/SecondParalax', -1390, -500);
		...
		makeAnimatedLuaSprite('tom', 'challeng-edd/TomEND', 1210, 299); -- tom !!
		...
		makeAnimatedLuaSprite('tord', 'challeng-edd/TordHelicopter', 1270, -45); -- this red mf
		...
		makeAnimatedLuaSprite('tord2', 'challeng-edd/TordFallin', 600, -845); -- this red mf fallin
	...
	makeAnimatedLuaSprite('tordbot', 'challeng-edd/TordBot', 340, -145); -- this red mf
	...
	makeLuaSprite('tordBG', 'challeng-edd/TordBG', -100, -200);
	setScrollFactor('tordBG', 0, 0);
	scaleObject('tordBG', 0.5, 0.5);
	setProperty('tordBG.alpha', 0);
	
	makeLuaSprite('cock', 'challeng-edd/CockPitUpClose', -20, -40);
