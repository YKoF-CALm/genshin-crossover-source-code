function onCreate()
    makeAnimatedLuaSprite('whittyfire', 'Whitty and Echo ability Sprites', -30.3, -64.2)
    luaSpriteAddAnimationByPrefix('whittyfire', 'blast', 'Fire Blast BF instance 1', 24, false)

    makeAnimatedLuaSprite('kleebullet', 'Whitty and Echo ability Sprites', -450, 130)
    luaSpriteAddAnimationByPrefix('kleebullet', 'shoot', 'Fire Shot instance', 1, false)

    makeAnimatedLuaSprite('whittybullet', 'Whitty and Echo ability Sprites', 150, 130)
