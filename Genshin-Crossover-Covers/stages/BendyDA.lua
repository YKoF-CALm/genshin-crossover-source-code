...
function onCreate()
  if songName == 'build-our-freaky-machine' then
    ...
    makeLuaSprite('bendyBGBlackWhite','indie/bendy/dabg - Black & White',-350,50)
    scaleObject('bendyBGBlackWhite',1.3,1.3)
    setProperty('bendyBGBlackWhite.visible',false)

    makeAnimatedLuaSprite('bendyVideoBlackWhite','indie/bendy/reel',-100,-100)
    addAnimationByPrefix('bendyVideoBlackWhite','bVideo','Bendy',12,true)
    setBlendMode('bendyVideoBlackWhite','add')
    scaleObject('bendyVideoBlackWhite',3,3)

    makeLuaSprite('Curtain1BlackWhite','indie/bendy/Curtain1 - Black & White',-300,-170)
    scaleObject('Curtain1BlackWhite',1.5,1.5)
    setProperty('Curtain1BlackWhite.visible',false)

    makeLuaSprite('Curtain2BlackWhite','indie/bendy/Curtain2 - Black & White',600,-170)
   ...
   if not lowQuality then
    ...
    makeLuaSprite('BendyVignette', 'indie/bendy/gay/C_07',0,0);
  ...
  makeAnimatedLuaSprite('bendyVideo','indie/bendy/reel',-100,-100)
  addAnimationByPrefix('bendyVideo','bVideo','Bendy',12,true)
  setBlendMode('bendyVideo','add')
  scaleObject('bendyVideo',3,3)


  makeLuaSprite('bendyBG','indie/bendy/dabg',-350,50)
  scaleObject('bendyBG',1.3,1.3)



  makeLuaSprite('Curtain1','indie/bendy/Curtain1',-300,-170)
  scaleObject('Curtain1',1.5,1.5)

  makeLuaSprite('Curtain2','indie/bendy/Curtain2',600,-170)
...
function onCreatePost()
  makeLuaSprite('prechaceNote','indie/bendy/NOTE_assets',0,0)
    ...
    if songName == 'build-our-freaky-machine' then
      if curStep == 1280 then
        for changeNote = 0,7 do
          setPropertyFromGroup('strumLineNotes',changeNote,'texture','indie/bendy/NOTE_assets')
        end
  ...
  if changeNotes == 2 then
    for notesAAA = 0,getProperty('notes.length')-1 do
      if getPropertyFromGroup('notes', notesAAA,'noteType') == '' then
        setPropertyFromGroup('notes', notesAAA,'texture','indie/bendy/NOTE_assets')
      end
    end
  end
