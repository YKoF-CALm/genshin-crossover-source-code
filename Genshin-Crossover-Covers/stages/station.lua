...
makeLuaSprite('bg','bbpanzu/soft/bg',-312.05,-48)
addLuaSprite('bg')
setScrollFactor('bg',0.2,0.2)

makeLuaSprite('cloud','bbpanzu/soft/cloud',-253.2,6)
addLuaSprite('cloud')
setScrollFactor('cloud',0.1,0.1)

makeAnimatedLuaSprite('train','bbpanzu/soft/train',-2200,234)
...
makeLuaSprite('station','bbpanzu/soft/station',-424.25,-159)
