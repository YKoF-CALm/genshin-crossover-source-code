function onCreate() 
 	makeLuaSprite('DTbg', 'garcello/DTbg', -100, -300);
	setScrollFactor('DTbg', 0.8, 0.8);
	scaleObject('DTbg', 0.75, 0.75);

	makeLuaSprite('carbehind', 'garcello/carbehind', 330, 200);
	setScrollFactor('carbehind', 0.8, 0.8);
	scaleObject('carbehind', 0.7, 0.7);

	makeLuaSprite('carback', 'garcello/carback', -140, 20);
	setScrollFactor('carback', 1, 1);
	scaleObject('carback', 0.8, 0.8);

	makeLuaSprite('carfront', 'garcello/carfront', -140, 20);
