function onCreate()
	...
	makeAnimatedLuaSprite('tankman', 'characters/tankmanCaptain', -1080, 125)
	addAnimationByPrefix('tankman', 'idle', 'Tankman Idle Dance 1', 24, false)
	addAnimationByPrefix('tankman', 'singLEFT', 'Tankman Right Note 1', 24, false)
	addAnimationByPrefix('tankman', 'singDOWN', 'Tankman DOWN note 1', 24, false)
	addAnimationByPrefix('tankman', 'singUP', 'Tankman UP note 1', 24, false)
	addAnimationByPrefix('tankman', 'singRIGHT', 'Tankman Note Left 1', 24, false)
	addAnimationByPrefix('tankman', 'well', 'PRETTY GOOD tankman 1', 24, false)
