...
function onCreate()
	...
	makeLuaSprite('bg', 'tricky/bg', -1200, -650);
	setLuaSpriteScrollFactor('bg', 0.9);

	makeLuaSprite('Energywall', 'tricky/Energywall', 1200, -200);

	makeLuaSprite('Spawnhole_Ground_BACK', 'tricky/Spawnhole_Ground_BACK', 80, 820);

	makeLuaSprite('Spawnhole_Ground_COVER', 'tricky/Spawnhole_Ground_COVER', 30, 845);
	
	makeLuaSprite('exback', 'tricky/exback', -650, -200);

	makeLuaSprite('exbackcover', 'tricky/exbackcover', -93, 870);
