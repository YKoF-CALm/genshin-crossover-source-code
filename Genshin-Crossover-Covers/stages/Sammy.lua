function onCreate()
	...
	makeLuaSprite('SammyBG', 'indie/bendy/SammyS', -600, -150);
	scaleObject('SammyBG',0.8,0.8)
    addLuaSprite('SammyBG', false);

    if not lowQuality then
	 makeAnimatedLuaSprite('Candle', 'indie/bendy/Candles',600,1470);
	 ...
	 makeAnimatedLuaSprite('CandleLight', 'indie/bendy/Candles',370,1280);
