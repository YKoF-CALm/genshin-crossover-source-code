function onCreate()
    ...
    if not lowQuality then
        makeLuaSprite('WhooshWhite', 'crossed-out/WhooshWhite', 0, 0);
        setObjectCamera('WhooshWhite', 'camHUD');
        precacheImage('crossed-out/WhooshWhite')
        
        makeAnimatedLuaSprite('BendyStage_Transition','crossed-out/BendyStage_Transition', -550, -450)
    ...
    makeLuaSprite('InkSplash_Ink','crossed-out/InkSplash_Ink', 0, 0)
