...
function onEvent(name, value1, value2)
	if name == 'Final_Change' then
		if value1 == 'c' then
			triggerEvent('Change Character', 'dad', 'ganyu-crossed-out')
		...
		elseif value1 == 's' then
			triggerEvent('Change Character', 'dad', 'xiao-crossed-out')
		...
		elseif value1 == 'b' then
			triggerEvent('Change Character', 'dad', 'zhongli-crossed-out')
