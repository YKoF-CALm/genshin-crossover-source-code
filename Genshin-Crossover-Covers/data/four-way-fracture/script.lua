...
function onUpdate(elapsed)
    ...
    if (curStep >= 1044 and curStep <= 1299) or (curStep >= 4180 and curStep <= 5248) or (curStep >= 6164)  then
        xx = 500;
        yy = 250;
        xx2 = 800;
        yy2 = 400;
    elseif curStep >= 1300 and curStep <= 2323 then
        xx = 800;
        yy = 400;
        xx2 = 500;
        yy2 = 400;
    elseif curStep >= 2324 and curStep <= 2815 then
        xx = 800;
        yy = 250;
        xx2 = 500;
        yy2 = 400;
...
function onStepHit()
    ...
    if curStep == 6356 then
        setProperty('gf.x', getProperty('gf.x') + 700)
...
function onTimerCompleted(tag, loops, loopsLeft)
    if tag == 'bye2' then
        removeLuaSprite('js1', true)
        removeLuaSprite('jumpstatic', false)
    end

    if tag == 'bye3' then
        removeLuaSprite('js2', true)
        removeLuaSprite('jumpstatic', false)
    end

    if tag == 'bye4' then
        removeLuaSprite('js3', true)
        removeLuaSprite('jumpstatic', false)
    end

    if tag == 'bye5' then
        removeLuaSprite('js4', true)
        removeLuaSprite('jumpstatic', false)
    end

    if tag == 'bye6' then
        removeLuaSprite('js5', true)
        removeLuaSprite('jumpstatic', false)
    end
end