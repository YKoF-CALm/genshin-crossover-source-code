...
local yy = 730; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 1220; -- Same code as above, but for boyfriend left, right
local yy2 = 730; -- Same code as above, but for boyfriend up, down
                ...
                function onUpdate() -- The Main Code
                    ...
                    if followchars == true then
                        if mustHitSection == false then -- Code for the camera to follow the poses of your opponent
                            ...
                            if getProperty('dad.animation.curAnim.name') == 'idle' or getProperty('dad.animation.curAnim.name') == 'edgy line' or getProperty('dad.animation.curAnim.name') == 'leaves' then
                                triggerEvent('Camera Follow Pos',xx,yy)
                            end
