function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'halfBlammed Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'notes/HALFBLAMNOTE_assets'); --Change texture
			setPropertyFromGroup('unspawnNotes', i, 'noteSplashTexture', 'notesplashes/halfBlamSplash'); -- change splash
