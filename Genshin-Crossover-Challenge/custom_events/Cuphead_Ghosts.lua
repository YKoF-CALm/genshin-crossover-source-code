function onCreate()
	if not lowQuality then
		makeAnimatedLuaSprite('CupheadStage2_BfGhost','crossed-out/CupheadStage2_BfGhost', 1200, 200)
		...
		makeAnimatedLuaSprite('CupheadStage2_BfGhost2','crossed-out/CupheadStage2_BfGhost', -100, 200)
