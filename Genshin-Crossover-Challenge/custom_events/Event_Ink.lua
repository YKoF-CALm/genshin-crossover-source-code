...
function onCreate()
	if not lowQuality then
		makeAnimatedLuaSprite('Ink_shit1','crossed-out/Ink_shit', -280, 0)
		...
		makeAnimatedLuaSprite('Ink_shit2','crossed-out/Ink_shit', 482, -0)
		...
		makeAnimatedLuaSprite('Ink_shit3','crossed-out/Ink_shit', 1244, -0)
		...
		makeAnimatedLuaSprite('BendyStage2_InkRain','crossed-out/BendyStage2_InkRain', 0, 0)
