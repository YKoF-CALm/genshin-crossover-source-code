	...
	if name == '2_StageChange' then
        if not lowQuality then        
            ...
            elseif value1 == 'Cup2' then -- Cuphead Night
                ...
                -- Made later for less lag? 
                    makeLuaSprite('SansStage3_Back', 'crossed-out/SansStage3_Back', -800, -550);
                    setScrollFactor('SansStage3_Back', 1, 1);
                    scaleObject('SansStage3_Back', 2, 2);
                    makeLuaSprite('SansStage4_Front', 'crossed-out/SansStage4_Front', -800, -550);
            ...
            elseif value1 == 'San1' then -- Sans's Hallway
                triggerEvent('Change Character', 'dad', 'xiao-indie-sans-sit')
            ...
            -- Made later for less lag?
                makeLuaSprite('SansStage4_BackFrame1', 'crossed-out/SansStage4_BackFrame1', -800, -550);
                ...
                makeLuaSprite('SansStage4_BackFrame2', 'crossed-out/SansStage4_BackFrame2', -800, -550);
            ...
            elseif value1 == 'San1.5' then -- Sans's serious 
                triggerEvent('Change Character', 'dad', 'xiao-indie-sans')

                -- Made later for less lag?
                    makeLuaSprite('BendyStage1_Boi', 'crossed-out/BendyStage1_Boi', 400, 100);
            ...
            elseif value1 == 'San2' then -- The undertale black bg
                triggerEvent('Change Character', 'dad', 'xiao-indie-attack')
                ...
                -- Made later for less Lag?
                    makeLuaSprite('BendyStage1_Background', 'crossed-out/BendyStage1_Background', -400, -550);
                    setScrollFactor('BendyStage1_Background', 0.7, 0.7);
                    makeLuaSprite('BendyStage1_Back', 'crossed-out/BendyStage1_Back', -800, -550);
            ...
            elseif value1 == 'San3' then -- Sans's Snow Stage with Cuphead
                triggerEvent('Change Character', 'dad', 'xiao-indie')
                triggerEvent('Change Character', 'bf', 'bf_sans_3')
                triggerEvent('Change Character', 'gf', 'ganyu-indie-mad')
            ...
            elseif value1 == 'San4' then -- Makes Bf have Guitar, also does stuff to make the solo stuff possible
                ...
                -- made later for less lag?
                    makeLuaSprite('Final_Stars3', 'crossed-out/Final_Stars3', -1600, -800);
                    setScrollFactor('Final_Stars3', 0.2, 0.2);
                    scaleObject('Final_Stars3', 1.5, 1.5);
                    makeLuaSprite('Final_Stars4', 'crossed-out/Final_Stars4', -1600, -800);
            ...
            elseif value1 == 'Ben1' then -- Bendy's normal Stage
                triggerEvent('Change Character', 'dad', 'zhongli-indie-bendy')
            ...
            elseif value1 == 'Ben2' then -- Bendy's run Stage
                triggerEvent('Change Character', 'dad', 'zhongli-indie-fly')
                ...
                -- made later for less lag?
                    makeLuaSprite('Final_Stars5', 'crossed-out/Final_Stars3', -1600, -800);
                    setScrollFactor('Final_Star5', 1.4, 1.4);
                    scaleObject('Final_Stars5', 3, 3);
                    makeLuaSprite('Final_Stars6', 'crossed-out/Final_Stars4', -1600, -800);
            ...
            elseif value1 == 'Ben3' then -- Bendy's run Stage but dark...
                triggerEvent('Change Character', 'dad', 'zhongli-indie-fly-dark')
...
function onCreate()
    if not lowQuality then        
        makeLuaSprite('BendyBlackScreen', 'crossed-out/BendyBlackScreen', 0, 0);
