...
function onCreate()
    ...
    makeLuaSprite('CreditsStart','crossed-out/CreditsStart', 1800, 300) 
...
function opponentNoteHit(id, noteData, noteType, isSustainNote)
    if (dadName == 'bendy_normal') or (dadName == 'bendy_run') or (dadName == 'bendy_run_dark') or (dadName == 'final_bendy') or (dadName == 'zhongli-indie-bendy') or (dadName == 'zhongli-indie-fly') or (dadName == 'zhongli-indie-fly-dark') or (dadName == 'zhongli-crossed-out') then
